...
// GameOverlay — the full-screen overlay shown during 'boon_select', 'game_over', and 'victory' phases.
// Returns null for all other phases.
export function GameOverlay({
  phase, choices, shopRerolls,
  displayBoonGroups, shownBoons,
  sc, victoryIsGameOver,
  collection, collectionAtRunStart,
  seenBoons, totalBoons,
  pick, rerollChoices, restart, enterEndless, setShowCollection,
}) {
  if (phase !== 'boon_select' && phase !== 'game_over' && phase !== 'victory') return null;
    ...
    <div className="game-overlay" onClick={function(e) { e.stopPropagation(); }}>
      ...
      {phase === 'game_over' && (
        <div className="game-over-panel">
          ...
          <button className="again-btn" onClick={function(e) { e.stopPropagation(); restart(); }}>PLAY AGAIN</button>
