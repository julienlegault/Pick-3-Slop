...
// PhaseBanner — full-screen overlays for transient phase banners:
//   'growing', 'victory_grow', 'doom_approaches', 'doom_reveal'.
// Returns null for any other phase.
export function PhaseBanner({ phase, doomRevealGroup }) {
  if (phase === 'growing') {
    return (
