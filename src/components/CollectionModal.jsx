...
// CollectionModal — full-screen collection browser.
// Props: showCollection, collection, setShowCollection, totalBoons, seenBoons
export function CollectionModal({ showCollection, collection, setShowCollection, totalBoons, seenBoons }) {
        ...
        <div className="boon-grid">
          ...
          {collection.has('doom_unlock') && (
            <div
              key="doom_unlock"
              className="boon-grid-item"
              style={{ border: '1px solid #CC101088', background: 'rgba(180,16,16,.08)' }}
            >
